...
const variants: VariantConfig[] = [
    {
        ...
        description: 'Interactive chart with toggle between scatter, line, and bar views. Shows confidence intervals across demographic categories.',
        sampleData: 'obesity.json',
        componentPath: 'recharts/generic/demographic-breakdown-v1',
        Component: DemographicBreakdown,
    },
    {
        id: 'panel',
        name: 'Multi-Panel',
        description: 'Side-by-side panel layout showing bar charts for each demographic category. Built with Observable Plot.',
        sampleData: 'https://ontopic-public-data.t3.storage.dev/cdc-data/brfss_state/examples/DRNKANY5_us_median.json',
        componentPath: 'plot/stats/demographic-panel-v1',
    ...
    return (
        <div className="relative">
            ...
            <div className="py-6 px-4 max-w-4xl mx-auto lg:mr-56 space-y-12">
                {/* Header */}
                <div className="space-y-4">
                    <h1 className="text-4xl font-black tracking-tight text-foreground">Demographic Charts</h1>
                    <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl">
                        Visualizations for demographic breakdowns showing how health and social indicators vary across age, income, education, and other demographic groups.
                    </p>
