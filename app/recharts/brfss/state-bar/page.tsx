...
// Import state bar components
import StateBarSortable from '@/viz/components/recharts/brfss/state-bar-sortable-v1';
import StateBarPlot from '@/viz/components/plot/brfss/state-bar-v1';
...
const variants: VariantConfig[] = [
    {
        ...
        description: 'Interactive sortable horizontal bar chart with demographic breakdowns. Built with Recharts.',
        sampleData: 'state-visualization-data.json',
        componentPath: 'recharts/brfss/state-bar-sortable-v1',
        Component: StateBarSortable,
    },
    {
        id: 'plot',
        name: 'Ordered (Observable Plot)',
        description: 'Clean ordered horizontal bar chart for state-level health indicators. Built with Observable Plot.',
        sampleData: 'https://ontopic-public-data.t3.storage.dev/cdc-data/brfss_state/examples/DRNKANY5_state_map.json',
        componentPath: 'plot/brfss/state-bar-v1',
...
export default function StateBarPage() {
    return (
        <div className="relative">
            {/* Main content */}
            <div className="py-6 px-4 max-w-4xl mx-auto lg:mr-56 space-y-12">
                {/* Header */}
                <div className="space-y-4">
                    <h1 className="text-4xl font-black tracking-tight text-foreground">State Bar Charts</h1>
                    <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl">
                        Horizontal bar charts for comparing state-level health indicators from CDC BRFSS data. Available in both Recharts and Observable Plot implementations.
                    </p>
