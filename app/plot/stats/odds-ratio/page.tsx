...
const variants: VariantConfig[] = [
    {
        id: 'basic',
        name: 'Basic',
        description: 'Standard odds ratio visualization with confidence intervals. Points are colored by effect direction.',
        sampleData: 'odds-ratio-data.json',
        componentPath: 'plot/stats/odds-ratio-basic-v1',
    ...
    },
    {
        id: 'forest',
        name: 'Forest Plot',
        description: 'Advanced forest plot with enhanced visual features including shaded confidence regions and end caps.',
        sampleData: 'odds-ratio-data.json',
        componentPath: 'plot/stats/odds-ratio-forest-v1',
    ...
    },
    {
        ...
        description: 'Dot plot where marker size reflects statistical precision - smaller confidence intervals yield larger dots.',
        sampleData: 'odds-ratio-data.json',
        componentPath: 'plot/stats/odds-ratio-dotplot-v1',
    ...
    return (
        <section id={variant.id} className="scroll-mt-20">
            <div className="space-y-4">
                ...
                <div className={cn(
                    "rounded-xl border border-border shadow-lg overflow-hidden min-h-[500px] flex items-center justify-center relative",
    ...
    return (
        <div className="relative">
            ...
            <div className="py-6 px-4 max-w-4xl mx-auto lg:mr-56 space-y-12">
                {/* Header */}
                <div className="space-y-4">
                    <h1 className="text-4xl font-black tracking-tight text-foreground">Odds Ratio Charts</h1>
                    <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl">
                        Statistical visualizations for odds ratios with confidence intervals. Multiple styles for presenting effect sizes and statistical significance.
                    </p>
